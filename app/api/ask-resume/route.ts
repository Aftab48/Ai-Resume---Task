...
const PDF_CO_API_KEY = process.env.PDF_CO_API_KEY || "demo";
              ...
              messages: [
                {
                  role: "system",
                  content:
                  "You are an AI assistant helping answer questions about a resume. Provide concise, helpful, and accurate answers based only on the provided resume text. Always return plain text only. Do not use Markdown, asterisks, bullets, bold, italics, code blocks, or headings."
                },
                {
                  role: "user",
